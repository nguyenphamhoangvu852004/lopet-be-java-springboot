...
public final class AccountProfileFactory {
    ...
    /**
     * {@code fullName} lấy theo username thay vì một cái tên bịa: hồ sơ này không còn endpoint đọc
     * công khai nào, nhưng chính chủ vẫn thấy nó ở {@code GET /v1/account-profiles/me} và một cái tên
     * bịa ở đó là dữ liệu sai chứ không phải chỗ trống.
     *
     * <p>Các trường chuỗi còn lại để rỗng chứ không để null — {@code AccountProfileService} vốn đã chuẩn
