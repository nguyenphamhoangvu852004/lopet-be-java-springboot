...
public interface PostRepository extends JpaRepository<Post, Integer> {
    ...
    /**
     * Dùng bởi {@link com.nguyenvu.lopet.bootstrap.SeedDemoPosts} để không seed lại bài demo ở lần
     * khởi động thứ hai. Không đi qua {@link PostVisibility} vì đây là câu hỏi về sự tồn tại, không
     * phải về quyền xem.
     */
